...
class Hero(Character):
    ...
    def __init__(self, name, live, mana, power, knack, intel, exp, level):
        ...
        super(Hero, self).__init__(name, live, mana)
        self.thisPower = power
        self.thisKhack = knack
    ...
    def attack(self, target, damage):
        ...
        return f'Я будущий герой {self.thisName}, и я без оружия, но я нанес {target.thisName} урон {damage} своими руками'