...
class TestWarrion(unittest.TestCase):
    ...
    def test_UpState(self):
        ...
        # ввод данных
        test_object_1 = Warrion('Миша', 100, 0, 1, 1, 1, 0, 1, 'нож')
        test_object_2 = Warrion('Денис', 100, 67, 89, 54, 56, 7, 2, 'мяч')
    ...
    def test_scream(self):
        ...
        test_object = Warrion('Миша', 100, 67, 89, 54, 56, 7, 2, 'нож')
    ...
    def test_attach(self):
        ...
        test_object_1 = Warrion('Миша', 34, 67, 89, 54, 56, 7, 2, 'нож')
        test_object_2 = Warrion('Денис', 100, 67, 89, 54, 56, 7, 2, 'мяч')
